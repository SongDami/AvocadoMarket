...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/css/notice_tab_style.css?ver=<%=System.currentTimeMillis()%>" />
<div class="tab-tbody">
	<!-- 공지사항 타이틀  -->
	<div class="tab-title" id="notice-title">공지사항</div>
	<div id="faq_title"></div>
	<!-- 공지 사항/자주 묻는 질문 탭 -->
	<div class="tab-btn">
	<ul class="notice-faq-tab">
		<li class="NAQ-btn-li">
			<a class="NAQ-btn selected" href="#notice_table_c">공지사항</a>
		</li>
		<li class="NAQ-btn-li">
			<a class="NAQ-btn" href="#faq_table_c">자주 묻는 질문</a>
		</li>
	</ul>
	</div>
	<!-- 검색창 -->
